/**
 * Hierarchical Geographic Database & Search Engine (Server Side)
...
export const JORDAN_GEO: GeoCountry = {
  ...
  cities: [
    ...
    { nameAr: 'مادبا', nameEn: 'Madaba', stateAr: 'محافظة مادبا', stateEn: 'Madaba', countryAr: 'الأردن', countryEn: 'Jordan', countryCode: 'jo', flag: '🇯🇴', type: 'city' },
    { nameAr: 'جرش', nameEn: 'Jerash', stateAr: 'محافظة جرش', stateEn: 'Jerash', countryAr: 'الأردن', countryEn: 'Jordan', countryCode: 'jo', flag: '🇯🇴', type: 'city' },
    { nameAr: 'عجلون', nameEn: 'Ajloun', stateAr: 'محافظة عجلون', stateEn: 'Ajloun', countryAr: 'الأردن', countryEn: 'Jordan', countryCode: 'jo', flag: '🇯🇴', type: 'city' },
    { nameAr: 'المفرق', nameEn: 'Mafraq', stateAr: 'محافظة المفرق', stateEn: 'Mafraq', countryAr: 'الأردن', countryEn: 'Jordan', countryCode: 'jo', flag: '🇯🇴', type: 'city' },
    { nameAr: 'معان', nameEn: 'Maan', stateAr: 'محافظة معان والبتراء', stateEn: 'Maan', countryAr: 'الأردن', countryEn: 'Jordan', countryCode: 'jo', flag: '🇯🇴', type: 'city' },
    { nameAr: 'الطفيلة', nameEn: 'Tafilah', stateAr: 'محافظة الطفيلة', stateEn: 'Tafilah', countryAr: 'الأردن', countryEn: 'Jordan', countryCode: 'jo', flag: '🇯🇴', type: 'city' },
  ],
};
  ...
  cities: [
    ...
    },
    {
      ...
      subLocalities: [
        ...
        { nameAr: 'البلد', nameEn: 'Al-Balad', type: 'neighborhood' },
      ],
    },
    {
      nameAr: 'مكة المكرمة',
    ...
    },
    {
      ...
      subLocalities: [
        ...
        { nameAr: 'الأحساء', nameEn: 'Al-Ahsa', type: 'city' },
      ],
    },
    { nameAr: 'تبوك', nameEn: 'Tabuk', stateAr: 'منطقة تبوك', stateEn: 'Tabuk', countryAr: 'المملكة العربية السعودية', countryEn: 'Saudi Arabia', countryCode: 'sa', flag: '🇸🇦', type: 'city' },
    { nameAr: 'أبها وخميس مشيط', nameEn: 'Abha & Khamis Mushait', stateAr: 'منطقة عسير', stateEn: 'Asir', countryAr: 'المملكة العربية السعودية', countryEn: 'Saudi Arabia', countryCode: 'sa', flag: '🇸🇦', type: 'city' },
    { nameAr: 'جازان', nameEn: 'Jazan', stateAr: 'منطقة جازان', stateEn: 'Jazan', countryAr: 'المملكة العربية السعودية', countryEn: 'Saudi Arabia', countryCode: 'sa', flag: '🇸🇦', type: 'city' },
    { nameAr: 'القصيم (بريدة وعنيزة)', nameEn: 'Qassim', stateAr: 'منطقة القصيم', stateEn: 'Qassim', countryAr: 'المملكة العربية السعودية', countryEn: 'Saudi Arabia', countryCode: 'sa', flag: '🇸🇦', type: 'city' },
  ],
};
  ...
  cities: [
    {
      ...
      subLocalities: [
        ...
        { nameAr: 'التجمع الخامس (القاهرة الجديدة)', nameEn: 'New Cairo', type: 'city' },
    ...
    { nameAr: 'طنطا (الغربية)', nameEn: 'Tanta', stateAr: 'محافظة الغربية، مصر', stateEn: 'Gharbia', countryAr: 'مصر', countryEn: 'Egypt', countryCode: 'eg', flag: '🇪🇬', type: 'city' },
    { nameAr: 'بورسعيد', nameEn: 'Port Said', stateAr: 'محافظة بورسعيد', stateEn: 'Port Said', countryAr: 'مصر', countryEn: 'Egypt', countryCode: 'eg', flag: '🇪🇬', type: 'city' },
    { nameAr: 'السويس', nameEn: 'Suez', stateAr: 'محافظة السويس', stateEn: 'Suez', countryAr: 'مصر', countryEn: 'Egypt', countryCode: 'eg', flag: '🇪🇬', type: 'city' },
    { nameAr: 'الإسماعيلية', nameEn: 'Ismailia', stateAr: 'محافظة الإسماعيلية', stateEn: 'Ismailia', countryAr: 'مصر', countryEn: 'Egypt', countryCode: 'eg', flag: '🇪🇬', type: 'city' },
  ],
};
...
export const UAE_GEO: GeoCountry = {
  ...
  cities: [
    ...
    { nameAr: 'الشارقة', nameEn: 'Sharjah', stateAr: 'إمارة الشارقة', stateEn: 'Sharjah', countryAr: 'الإمارات العربية المتحدة', countryEn: 'United Arab Emirates', countryCode: 'ae', flag: '🇦🇪', type: 'city' },
    { nameAr: 'عجمان', nameEn: 'Ajman', stateAr: 'إمارة عجمان', stateEn: 'Ajman', countryAr: 'الإمارات العربية المتحدة', countryEn: 'United Arab Emirates', countryCode: 'ae', flag: '🇦🇪', type: 'city' },
    { nameAr: 'رأس الخيمة', nameEn: 'Ras Al Khaimah', stateAr: 'إمارة رأس الخيمة', stateEn: 'Ras Al Khaimah', countryAr: 'الإمارات العربية المتحدة', countryEn: 'United Arab Emirates', countryCode: 'ae', flag: '🇦🇪', type: 'city' },
    { nameAr: 'الفجيرة', nameEn: 'Fujairah', stateAr: 'إمارة الفجيرة', stateEn: 'Fujairah', countryAr: 'الإمارات العربية المتحدة', countryEn: 'United Arab Emirates', countryCode: 'ae', flag: '🇦🇪', type: 'city' },
  ],
};
...
export const LEBANON_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'بيروت', nameEn: 'Beirut', stateAr: 'محافظة بيروت (العاصمة)', stateEn: 'Beirut', countryAr: 'لبنان', countryEn: 'Lebanon', countryCode: 'lb', flag: '🇱🇧', type: 'capital' },
    {
      nameAr: 'طرابلس (لبنان)',
    ...
    { nameAr: 'صيدا', nameEn: 'Sidon (Saida)', stateAr: 'محافظة الجنوب، لبنان', stateEn: 'South Lebanon', countryAr: 'لبنان', countryEn: 'Lebanon', countryCode: 'lb', flag: '🇱🇧', type: 'city' },
    { nameAr: 'صور', nameEn: 'Tyre (Sour)', stateAr: 'محافظة الجنوب، لبنان', stateEn: 'South Lebanon', countryAr: 'لبنان', countryEn: 'Lebanon', countryCode: 'lb', flag: '🇱🇧', type: 'city' },
    { nameAr: 'زحلة والبقاع', nameEn: 'Zahle & Bekaa', stateAr: 'محافظة البقاع، لبنان', stateEn: 'Bekaa', countryAr: 'لبنان', countryEn: 'Lebanon', countryCode: 'lb', flag: '🇱🇧', type: 'city' },
  ],
};
...
export const LIBYA_GEO: GeoCountry = {
  ...
  cities: [
    ...
    { nameAr: 'بنغازي', nameEn: 'Benghazi', stateAr: 'شعبية بنغازي، ليبيا', stateEn: 'Benghazi', countryAr: 'ليبيا', countryEn: 'Libya', countryCode: 'ly', flag: '🇱🇾', type: 'city' },
    { nameAr: 'مصراتة', nameEn: 'Misrata', stateAr: 'شعبية مصراتة، ليبيا', stateEn: 'Misrata', countryAr: 'ليبيا', countryEn: 'Libya', countryCode: 'ly', flag: '🇱🇾', type: 'city' },
  ],
};
...
export const YEMEN_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'صنعاء', nameEn: 'Sanaa', stateAr: 'العاصمة، الجمهورية اليمنية', stateEn: 'Capital of Yemen', countryAr: 'اليمن', countryEn: 'Yemen', countryCode: 'ye', flag: '🇾🇪', type: 'capital' },
    {
      nameAr: 'عدن',
      nameEn: 'Aden',
      ...
      subLocalities: [
        ...
        { nameAr: 'كريتر', nameEn: 'Crater', type: 'neighborhood' },
        { nameAr: 'الشيخ عثمان', nameEn: 'Sheikh Othman', type: 'district' },
      ],
    },
    { nameAr: 'تعز', nameEn: 'Taiz', countryAr: 'اليمن', countryEn: 'Yemen', countryCode: 'ye', flag: '🇾🇪', type: 'city' },
  ],
};
...
export const IRAQ_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'بغداد', nameEn: 'Baghdad', stateAr: 'محافظة بغداد (العاصمة)', stateEn: 'Baghdad', countryAr: 'العراق', countryEn: 'Iraq', countryCode: 'iq', flag: '🇮🇶', type: 'capital' },
    { nameAr: 'أربيل', nameEn: 'Erbil', stateAr: 'إقليم كردستان، العراق', stateEn: 'Erbil', countryAr: 'العراق', countryEn: 'Iraq', countryCode: 'iq', flag: '🇮🇶', type: 'city' },
    { nameAr: 'البصرة', nameEn: 'Basra', stateAr: 'محافظة البصرة', stateEn: 'Basra', countryAr: 'العراق', countryEn: 'Iraq', countryCode: 'iq', flag: '🇮🇶', type: 'city' },
    { nameAr: 'الموصل', nameEn: 'Mosul', stateAr: 'محافظة نينوى', stateEn: 'Mosul', countryAr: 'العراق', countryEn: 'Iraq', countryCode: 'iq', flag: '🇮🇶', type: 'city' },
  ],
};
...
export const SYRIA_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'دمشق', nameEn: 'Damascus', stateAr: 'محافظة دمشق (العاصمة)', stateEn: 'Damascus', countryAr: 'سوريا', countryEn: 'Syria', countryCode: 'sy', flag: '🇸🇾', type: 'capital' },
    { nameAr: 'حلب', nameEn: 'Aleppo', stateAr: 'محافظة حلب', stateEn: 'Aleppo', countryAr: 'سوريا', countryEn: 'Syria', countryCode: 'sy', flag: '🇸🇾', type: 'city' },
    { nameAr: 'حمص', nameEn: 'Homs', stateAr: 'محافظة حمص', stateEn: 'Homs', countryAr: 'سوريا', countryEn: 'Syria', countryCode: 'sy', flag: '🇸🇾', type: 'city' },
  ],
};
...
export const QATAR_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'الدوحة', nameEn: 'Doha', stateAr: 'بلدية الدوحة (العاصمة)', stateEn: 'Doha', countryAr: 'قطر', countryEn: 'Qatar', countryCode: 'qa', flag: '🇶🇦', type: 'capital' },
    ...
    { nameAr: 'لوسيل', nameEn: 'Lusail', countryAr: 'قطر', countryEn: 'Qatar', countryCode: 'qa', flag: '🇶🇦', type: 'city' },
  ],
};
...
export const KUWAIT_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'مدينة الكويت', nameEn: 'Kuwait City', stateAr: 'العاصمة الكويت', stateEn: 'Kuwait City', countryAr: 'الكويت', countryEn: 'Kuwait', countryCode: 'kw', flag: '🇰🇼', type: 'capital' },
    { nameAr: 'السالمية', nameEn: 'Salmiya', countryAr: 'الكويت', countryEn: 'Kuwait', countryCode: 'kw', flag: '🇰🇼', type: 'city' },
    { nameAr: 'حولي', nameEn: 'Hawalli', countryAr: 'الكويت', countryEn: 'Kuwait', countryCode: 'kw', flag: '🇰🇼', type: 'city' },
  ],
};
...
export const BAHRAIN_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'المنامة', nameEn: 'Manama', stateAr: 'محافظة العاصمة، البحرين', stateEn: 'Manama', countryAr: 'البحرين', countryEn: 'Bahrain', countryCode: 'bh', flag: '🇧🇭', type: 'capital' },
    { nameAr: 'المحرق', nameEn: 'Muharraq', countryAr: 'البحرين', countryEn: 'Bahrain', countryCode: 'bh', flag: '🇧🇭', type: 'city' },
  ],
};
...
export const OMAN_GEO: GeoCountry = {
  ...
  cities: [
    { nameAr: 'مسقط', nameEn: 'Muscat', stateAr: 'محافظة مسقط (العاصمة)', stateEn: 'Muscat', countryAr: 'سلطنة عمان', countryEn: 'Oman', countryCode: 'om', flag: '🇴🇲', type: 'capital' },
    { nameAr: 'صلالة', nameEn: 'Salalah', stateAr: 'محافظة ظفار', stateEn: 'Dhofar', countryAr: 'سلطنة عمان', countryEn: 'Oman', countryCode: 'om', flag: '🇴🇲', type: 'city' },
  ],
};
...
export const MOROCCO_GEO: GeoCountry = {
  ...
  nameEn: 'Morocco',
  flag: '🇲🇦',
  keywords: ['المغرب', 'مغربي', 'morocco', 'casablanca', 'rabat'],
  cities: [
    ...
    { nameAr: 'الدار البيضاء (كازابلانكا)', nameEn: 'Casablanca', countryAr: 'المغرب', countryEn: 'Morocco', countryCode: 'ma', flag: '🇲🇦', type: 'city' },
    { nameAr: 'مراكش', nameEn: 'Marrakech', countryAr: 'المغرب', countryEn: 'Morocco', countryCode: 'ma', flag: '🇲🇦', type: 'city' },
    { nameAr: 'طنجة', nameEn: 'Tangier', countryAr: 'المغرب', countryEn: 'Morocco', countryCode: 'ma', flag: '🇲🇦', type: 'city' },
  ],
};
...
export const ALGERIA_GEO: GeoCountry = {
  ...
  cities: [
    ...
    { nameAr: 'وهران', nameEn: 'Oran', countryAr: 'الجزائر', countryEn: 'Algeria', countryCode: 'dz', flag: '🇩🇿', type: 'city' },
    { nameAr: 'قسنطينة', nameEn: 'Constantine', countryAr: 'الجزائر', countryEn: 'Algeria', countryCode: 'dz', flag: '🇩🇿', type: 'city' },
  ],
};
...
export const TURKEY_GEO: GeoCountry = {
  ...
  cities: [
    ...
    { nameAr: 'أنقرة', nameEn: 'Ankara', stateAr: 'العاصمة، الجمهورية التركية', stateEn: 'Ankara', countryAr: 'تركيا', countryEn: 'Turkey', countryCode: 'tr', flag: '🇹🇷', type: 'capital' },
    { nameAr: 'إزمير', nameEn: 'Izmir', countryAr: 'تركيا', countryEn: 'Turkey', countryCode: 'tr', flag: '🇹🇷', type: 'city' },
    { nameAr: 'أنطاليا', nameEn: 'Antalya', countryAr: 'تركيا', countryEn: 'Turkey', countryCode: 'tr', flag: '🇹🇷', type: 'city' },
  ],
};
