...
export const CORE_INDEXES: string[] = [
  ...
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_system_logs_created_at ON system_logs(created_at DESC)`,
  ...
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_files_user_id ON user_files(user_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_files_chat_id ON user_files(chat_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_files_file_url ON user_files(file_url)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_files_created_at ON user_files(created_at DESC)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_activity_logs_user_id ON user_activity_logs(user_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_activity_logs_event_type ON user_activity_logs(event_type)`,
