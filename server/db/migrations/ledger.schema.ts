...
export const LEDGER_INDEXES: string[] = [
  ...
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ledger_wallet ON ledger_transactions(wallet_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ledger_created ON ledger_transactions(created_at)`,
  ...
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ref_tree_referrer ON referral_tree(referrer_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ref_tree_referred ON referral_tree(referred_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ref_tree_ancestor ON referral_tree(ancestor_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ref_tree_descendant ON referral_tree(descendant_id)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS deposit_requests_pkey ON deposit_requests(id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deposit_requests_user ON deposit_requests(user_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deposit_requests_status ON deposit_requests(status)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS stripe_events_pkey ON stripe_events(id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_stripe_events_status ON stripe_events(status)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS kyc_requests_pkey ON kyc_requests(id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_kyc_user ON kyc_requests(user_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_kyc_status ON kyc_requests(status)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS withdrawal_requests_pkey ON withdrawal_requests(id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_withdrawals_user ON withdrawal_requests(user_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_withdrawals_status ON withdrawal_requests(status)`,
  `CREATE UNIQUE INDEX IF NOT EXISTS payout_accounts_pkey ON payout_accounts(id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_payout_accounts_user ON payout_accounts(user_id)`,
  ...
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_coupon_usages_coupon ON coupon_usages(coupon_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_coupon_usages_user ON coupon_usages(user_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ledger_user ON ledger_transactions(user_id)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ledger_type ON ledger_transactions(transaction_type)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ledger_status ON ledger_transactions(status)`,
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ledger_reference ON ledger_transactions(reference_id)`
];
