      ...
      {isOpen && triggerRect && (
        ...
        >
          ...
          <motion.div
            ...
            className={`z-[99999] rounded-[var(--radius-md)] border border-[var(--border-default)] bg-[var(--surface-card)] text-[var(--text-primary)] backdrop-blur-2xl ${SCROLL_STYLES.dropdown} max-h-[calc(100vh-24px)] ${coords.originClass} shadow-2xl ring-1 ring-black/5 dark:ring-white/10 transition-colors duration-fast p-1.5 flex flex-col gap-0.5 ${
